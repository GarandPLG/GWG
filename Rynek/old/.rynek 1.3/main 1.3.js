function main()
{
    ...
    let TECH = parseInt(document.getElementById("TECH").value),
        ...
        p_c_Ps = 0, p_c_Tk = 0, p_c_K = 0, p_c_Ul = 0, p_c_C = 0, p_c_U = 0, p_c_Zb = 0, p_c_We = 0,
        p_c_Ow = 0, p_c_Ml = 0, p_c_H = 0, p_c_Me = 0, p_c_Pa = 0, p_c_Sz = 0, p_c_Mi = 0, p_c_Ty = 0,
        p_c_R = 0, p_c_D = 0, p_c_Al = 0, p_c_Wi = 0, p_c_Po = 0,
...
{ 
    ...
    p_Zb -= p_p_Zb;
    r_Zb = c_Zb * (p_Zb - z_Zb);
    p_r_Zb = p_c_Zb * (p_p_Zb - p_z_Zb);
    if(r_Zb + p_r_Zb < 0)
    {
        lor_Zb = ((r_Zb + p_r_Zb) * 0.5).toFixed(0)/1;
    ...
    if(r_Al + p_r_Al < 0)
    {
        lor_Al = ((r_Al + p_r_Al) * 0.5).toFixed(0)/1;
    ...
    if(r_U + p_r_U < 0)
    {
        lor_U = ((r_U + p_r_U) * 0.5).toFixed(0)/1;
    ...
    if(r_Me + p_r_Me < 0)
    {
        lor_Me = ((r_Me + p_r_Me) * 0.5).toFixed(0)/1;
    ...
    if(r_D + p_r_D < 0)
    {
        lor_D = ((r_D + p_r_D) * 0.5).toFixed(0)/1;
    ...
    if(r_Tk + p_r_Tk < 0)
    {
        lor_Tk = ((r_Tk + p_r_Tk) * 0.5).toFixed(0)/1;
    ...
    if(r_R + p_r_R < 0)
    {
        lor_R = ((r_R + p_r_R) * 0.5).toFixed(0)/1;
    ...
    if(r_Ty + p_r_Ty < 0)
    {
        lor_Ty = ((r_Ty + p_r_Ty) * 0.5).toFixed(0)/1;
    ...
    if(r_Ps + p_r_Ps < 0)
    {
        lor_Ps = ((r_Ps + p_r_Ps) * 0.5).toFixed(0)/1;
    ...
    if(r_Mi + p_r_Mi < 0)
    {
        lor_Mi = ((r_Mi + p_r_Mi) * 0.5).toFixed(0)/1;
    ...
    if(r_Sz + p_r_Sz < 0)
    {
        lor_Sz = ((r_Sz + p_r_Sz) * 0.5).toFixed(0)/1;
    ...
    if(r_Wi + p_r_Wi < 0)
    {
        lor_Wi = ((r_Wi + p_r_Wi) * 0.5).toFixed(0)/1;
    ...
    if(r_Ml + p_r_Ml < 0)
    {
        lor_Ml = ((r_Ml + p_r_Ml) * 0.5).toFixed(0)/1;
    ...
    if(r_Ul + p_r_Ul < 0)
    {
        lor_Ul = ((r_Ul + p_r_Ul) * 0.5).toFixed(0)/1;
    ...
    if(r_We + p_r_We < 0)
    {
        lor_We = ((r_We + p_r_We) * 0.5).toFixed(0)/1;
    ...
    if(r_Po + p_r_Po < 0)
    {
        lor_Po = ((r_Po + p_r_Po) * 0.5).toFixed(0)/1;
    ...
    if(r_Ow + p_r_Ow < 0)
    {
        lor_Ow = ((r_Ow + p_r_Ow) * 0.5).toFixed(0)/1;
    ...
    if(r_K + p_r_K < 0)
    {
        lor_K = ((r_K + p_r_K) * 0.5).toFixed(0)/1;
    ...
    if(r_C + p_r_C < 0)
    {
        lor_C = ((r_C + p_r_C) * 0.5).toFixed(0)/1;
    ...
    if(r_H + p_r_H < 0)
    {
        lor_H = ((r_H + p_r_H) * 0.5).toFixed(0)/1;
    ...
    if(document.getElementById("kopia").checked)
    {
        let blob = new Blob(
           ["Technologia: ", TECH,
            ...
            "\n\n//ROZLICZENIE//",
            "\nProdukt - Produkcja - Zapotrzebowanie - Bilans - Cena Realna - Rozlicznie - Lack of Resources",
            "\n---Podstawowe dobra---",
            "\nProdukty spożywcze: ", `${p_Ps + p_p_Ps}, ${z_Ps + p_z_Ps}, ${(p_Ps + p_p_Ps) - (z_Ps + p_z_Ps)}, ${c_Ps}, ${r_Ps + p_r_Ps}, ${lor_Ps}`,
            "\nUbranie: ", `${p_U + p_p_U}, ${z_U + p_z_U}, ${(p_U + p_p_U) - (z_U + p_z_U)}, ${c_U}, ${r_U + p_r_U}, ${lor_U}`,
            "\nMebel: ", `${p_Me + p_p_Me}, ${z_Me + p_z_Me}, ${(p_Me + p_p_Me) - (z_Me + p_z_Me)}, ${c_Me}, ${r_Me + p_r_Me}, ${lor_Me}`,
            "\nRyba: ", `${p_R + p_p_R}, ${z_R + p_z_R}, ${(p_R + p_p_R) - (z_R + p_z_R)}, ${c_R}, ${r_R + p_r_R}, ${lor_R}`,
            "\nTkanina: ", `${p_Tk + p_p_Tk}, ${z_Tk + p_z_Tk}, ${(p_Tk + p_p_Tk) - (z_Tk + p_z_Tk)}, ${c_Tk}, ${r_Tk + p_r_Tk}, ${lor_Tk}`,
            "\nZboże: ", `${p_Zb + p_p_Zb}, ${z_Zb + p_z_Zb}, ${(p_Zb + p_p_Zb) - (z_Zb + p_z_Zb)}, ${c_Zb}, ${r_Zb + p_r_Zb}, ${lor_Zb}`,
            "\nPapier: ", `${p_Pa + p_p_Pa}, ${z_Pa + p_z_Pa}, ${(p_Pa + p_p_Pa) - (z_Pa + p_z_Pa)}, ${c_Pa}, ${r_Pa + p_r_Pa}, ${lor_Pa}`,
            "\nDrewno: ", `${p_D + p_p_D}, ${z_D + p_z_D}, ${(p_D + p_p_D) - (z_D + p_z_D)}, ${c_D}, ${r_D + p_r_D}, ${lor_D}`,
            "\n---Towary przemysłowe---",
            "\nŻelazo: ", `${p_Ze}, ${z_Ze}, ${p_Ze - z_Ze}, ${c_Ze}, ${r_Ze}, ${lor_Ze}`,
            "\nWęgiel: ", `${p_We + p_p_We}, ${z_We + p_z_We}, ${(p_We + p_p_We) - (z_We + p_z_We)}, ${c_We}, ${r_We + p_r_We}, ${lor_We}`,
            "\nNarzedzia: ", `${p_Nar}, ${z_Nar}, ${p_Nar - z_Nar}, ${c_Nar}, ${r_Nar}, ${lor_Nar}`,
            "\nBarwnik: ", `${p_Ba}, ${z_Ba}, ${p_Ba - z_Ba}, ${c_Ba}, ${r_Ba}, ${lor_Ba}`,
            "\nMateriały wybuchowe: ", `${p_Mw}, ${z_Mw}, ${p_Mw - z_Mw}, ${c_Mw}, ${r_Mw}, ${lor_Mw}`,
            "\nNawóz: ", `${p_Naw}, ${z_Naw}, ${p_Naw - z_Naw}, ${c_Naw}, ${r_Naw}, ${lor_Naw}`,
            "\nSzkło: ", `${p_Sz + p_p_Sz}, ${z_Sz + p_z_Sz}, ${(p_Sz + p_p_Sz) - (z_Sz + p_z_Sz)}, ${c_Sz}, ${r_Sz + p_r_Sz}, ${lor_Sz}`,
            "\nTwarde drewno: ", `${p_Td}, ${z_Td}, ${p_Td - z_Td}, ${c_Td}, ${r_Td}, ${lor_Td}`,
            "\nOłów: ", `${p_Ol}, ${z_Ol}, ${p_Ol - z_Ol}, ${c_Ol}, ${r_Ol}, ${lor_Ol}`,
            "\nJedwab: ", `${p_J}, ${z_J}, ${p_J - z_J}, ${c_J}, ${r_J}, ${lor_J}`,
            "\nStal: ", `${p_St}, ${z_St}, ${p_St - z_St}, ${c_St}, ${r_St}, ${lor_St}`,
            "\nSiarka: ", `${p_S}, ${z_S}, ${p_S - z_S}, ${c_S}, ${r_S}, ${lor_S}`,
            "\n---Towary luksusowe---",
            "\nKawa: ", `${p_K + p_p_K}, ${z_K + p_z_K}, ${(p_K + p_p_K) - (z_K + p_z_K)}, ${c_K}, ${r_K + p_r_K}, ${lor_K}`,
            "\nOwoc: ", `${p_Ow + p_p_Ow}, ${z_Ow + p_z_Ow}, ${(p_Ow + p_p_Ow) - (z_Ow + p_z_Ow)}, ${c_Ow}, ${r_Ow + p_r_Ow}, ${lor_K}`,
            "\nZłoto: ", `${p_Zl}, - , ${p_Zl}, - , ${r_Zl}, -`,
            "\nAlkohol: ", `${p_Al + p_p_Al}, ${z_Al + p_z_Al}, ${(p_Al + p_p_Al) - (z_Al + p_z_Al)}, ${c_Al}, ${r_Al + p_r_Al}, ${lor_Al}`,
            "\nUbranie luksusowe: ", `${p_Ul + p_p_Ul}, ${z_Ul + p_z_Ul}, ${(p_Ul + p_p_Ul) - (z_Ul + p_z_Ul)}, ${c_Ul}, ${r_Ul + p_r_Ul}, ${lor_Ul}`,
            "\nMebel luksusowy: ", `${p_Ml + p_p_Ml}, ${z_Ml + p_z_Ml}, ${(p_Ml + p_p_Ml) - (z_Ml + p_z_Ml)}, ${c_Ml}, ${r_Ml + p_r_Ml}, ${lor_Ml}`,
            "\nMięso: ", `${p_Mi + p_p_Mi}, ${z_Mi + p_z_Mi}, ${(p_Mi + p_p_Mi) - (z_Mi + p_z_Mi)}, ${c_Mi}, ${r_Mi + p_r_Mi}, ${lor_Mi}`,
            "\nPorcelana: ", `${p_Po + p_p_Po}, ${z_Po + p_z_Po}, ${(p_Po + p_p_Po) - (z_Po + p_z_Po)}, ${r_Po + p_r_Po}, ${lor_Po}`,
            "\nCukier: ", `${p_C + p_p_C}, ${z_C + p_z_C}, ${(p_C + p_p_C) - (z_C + p_z_C)}, ${c_C}, ${r_C + p_r_C}, ${lor_C}`,
            "\nHerbata: ", `${p_H + p_p_H}, ${z_H + p_z_H}, ${(p_H + p_p_H) - (z_H + p_z_H)}, ${c_H}, ${r_H + p_r_H}, ${lor_H}`,
            "\nTytoń: ", `${p_Ty + p_p_Ty}, ${z_Ty + p_z_Ty}, ${(p_Ty + p_p_Ty) - (z_Ty + p_z_Ty)}, ${c_Ty}, ${r_Ty + p_r_Ty}, ${lor_Ty}`, 
            "\nWino: ", `${p_Wi + p_p_Wi}, ${z_Wi + p_z_Wi}, ${(p_Wi + p_p_Wi) - (z_Wi + p_z_Wi)}, ${c_Wi}, ${r_Wi + p_r_Wi}, ${lor_Wi}`,
            "\n---Towary wojskowe---",
            "\nBroń: ", `${p_Br}, ${z_Br}, ${p_Br - z_Br}, ${c_Br}, ${r_Br}, ${lor_Br}`,
            "\nArtyleria: ", `${p_Ar}, ${z_Ar}, ${p_Ar - z_Ar}, ${c_Ar}, ${r_Ar}, ${lor_Ar}`,
            "\nAmunicja: ", `${p_Am}, ${z_Am}, ${p_Am - z_Am}, ${c_Am}, ${r_Am}, ${lor_Am}`,
            "\nStatek: ", `${p_Sta}, ${z_Sta}, ${p_Sta - z_Sta}, ${c_Sta}, ${r_Sta}, ${lor_Sta}`,
            "\n\n//ŁĄCZNIE//",
