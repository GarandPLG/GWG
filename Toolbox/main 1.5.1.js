function Main()
{
    let nazkra = document.getElementById("nazkra").value,
        ...
        SPR = IPR + PRr + DR + pocz_Uni * 2 + Uni * 2,
        prPRO = 0,
        nTECH = TECH,
    ...
    nTECH += Math.floor(SPR/250);
    SPR -= 250 * Math.floor(SPR/250);
    prPRO = ((SPR/250)*100).toFixed(2)/1;
